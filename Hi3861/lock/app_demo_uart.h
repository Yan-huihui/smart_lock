...
#define UART_BUFF_SIZE           32               //串口通信缓冲区长度32字节
#define WRITE_BY_INT                              //中断写
#define UART_DEMO_TASK_STAK_SIZE 2048             //栈大小
#define UART_DEMO_TASK_PRIORITY  25               //串口优先级
#define DEMO_UART_NUM            HI_UART_IDX_1    //串口1
